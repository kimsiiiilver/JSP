...
<body>
	...
	<div class="container" align="center">
		<div class="col-md-4 col-md-offset-4">
			...
			%>
			<form class="form-signin" action="addMemberProcess.jsp" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					placeholder="비밀번호" name="pass" id="inputPassword">
				</div>
				<div class="form-group">
					<label for="inputName" class="sr-only">이름</label> 
					<input type="text" class="form-control" 
					placeholder="이름" name="name" id="inputName">
				</div>
				<div class="form-group">
					<label for="inputPhone" class="sr-only">연락처</label> 
					<input type="text" class="form-control" 
					placeholder="010-1234-5678" name="phone" id="inputPhone">
				</div>
				<div class="form-group">
					<label for="inputAddress" class="sr-only">주소</label> 
					<input type="text" class="form-control" 
					placeholder="주소" name="address" id="inputAddress">
				</div>
				<div class="form-group">
